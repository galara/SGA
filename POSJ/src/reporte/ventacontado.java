 ...
 * @author Otto
 */
public class ventacontado extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reporte Venta Contado");
...
public void reporterunn(String repo, String repo1, String fecha3) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //this.jProgressBar1.minimumSize();
        //  this.jProgressBar1.Style =  ProgressBarStyle.Continuous;
        ...
        //id = "" + año + "-" + mes + "-" + dia;
        id = Helper.getFechaFormateada(Fecha1.getCalendar().getTime(), Helper.ANIO_MES_DIA);
        
        Calendar cal = new GregorianCalendar();
        cal.add(Calendar.DATE, 1);
        int mes2 = cal.get(Calendar.MONTH) + 1;

        //id3 = cal.get(Calendar.YEAR) + "-" + mes2 + "-" + cal.get(Calendar.DAY_OF_MONTH);
        id3=Helper.getFechaFormateada(cal.getTime(), Helper.ANIO_MES_DIA);
        //ids = "" + año1 + "-" + mes1 + "-" + dia1;
        ids = Helper.getFechaFormateada(Fecha2.getCalendar().getTime(), Helper.ANIO_MES_DIA);
        
        reporterunn(id, ids, id3);

        new Rcontado().setVisible(true);

        //System.out.print("El día de hoy es :" + id + " y " + ids);

        GregorianCalendar calendarios = new GregorianCalendar();
