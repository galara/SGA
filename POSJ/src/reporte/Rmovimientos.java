...
public class Rmovimientos extends javax.swing.JInternalFrame {
    ...
    public Rmovimientos() {
        ...
        String titulos2[] = {"Id", "Producto", "Cantidad", "Devolución", "Salida"};
    ...
    private void initComponents() {
        ...
        TablaDetalle.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Producto", "Cantidad", "Devolución", "Devolución"
            }
        ));
        ...
        if (TablaCliente.getRowCount() == 0 && TablaCliente.getSelectedRow() == -1) {
            ...
            if (TablaCliente.getSelectedRow() == -1) {
                ...
                try {
                    ...
                    String archivo = "";
                    if (tipo > 1) {
                        archivo = "credito.jasper";
                    } else {
                        archivo = "reimpresionContado.jasper";
                    }
                    if (archivo == null) {
    ...
    private void TablaClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaClienteMouseClicked
        ...
        try {
            ...
            while (rs2.next()) {
                ...
                datos[1] = (String) rs2.getString(4);
                datos[2] = (String) rs2.getString(2);
                datos[3] = (String) rs2.getString(3);
