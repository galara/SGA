 ...
 * @author GLARA
 */
public class ReporteDeVentasCredito extends javax.swing.JInternalFrame {

    /**
     * Creates new form Cliente
     */
    public ReporteDeVentasCredito() {
        initComponents();
        addEscapeKey();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("<--Reporte de Ventas Crédito-->");
    ...
    private void bntNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntNuevoActionPerformed
        ...
        if (Utilidades.esObligatorio(this.JPanelCampos, true)) {
            ...
            String nombrereporte = "ventacredito.jasper";
