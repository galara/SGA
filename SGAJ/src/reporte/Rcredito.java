 ...
 * @author Otto
 */
public class Rcredito extends javax.swing.JFrame {
public class hilos implements Runnable
{
    ...
    public void run ()
    {
fecha=ventacredito.fecha1();
fecha2=ventacredito.fecha2();
fecha3=ventacredito.fecha3();
...
{ 
        ...
        try
        {
            ...
            String archivo="ventacredito.jasper";
        ...
        catch(Exception j)
        {
          System.out.println("Mensajer de error "+j.getMessage());
                ...
                Logger.getLogger(Rcredito.class.getName()).log(Level.SEVERE, null, ex);
            }
...
hilo.start();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rcredito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
