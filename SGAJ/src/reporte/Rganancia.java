 ...
 * @author Otto
 */
public class Rganancia extends javax.swing.JFrame {
public class hilos implements Runnable
{
    ...
    public void run ()
    {
fecha=GananciaVenta.fecha1();
fecha2=GananciaVenta.fecha2();
fecha3=GananciaVenta.fecha3();
...
{ 
        ...
        try
        {
            ...
            String archivo="ganancia.jasper";
        ...
        catch(Exception j)
        {
          System.out.println("Mensajer de error "+j.getMessage());
                ...
                Logger.getLogger(Rganancia.class.getName()).log(Level.SEVERE, null, ex);
            }
...
hilo.start();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rganancia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
