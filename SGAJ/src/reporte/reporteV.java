...
{
    String fecha,fecha2,fecha3,jasp;
    ...
    public void run ()
    {
fecha=Rsalida.fecha1();
fecha2=Rsalida.fecha2();
fecha3=Rsalida.fecha3();
...
{ 
        ...
        try
        {
            ...
            String archivo="xlssalidas.jasper";
        ...
        catch(Exception j)
        {
          System.out.println("Mensajer de error "+j.getMessage());
                ...
                Logger.getLogger(reporteV.class.getName()).log(Level.SEVERE, null, ex);
            }
