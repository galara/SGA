 ...
 * @author 30234
 */
public class Detalledevoluvionesproveedor extends javax.swing.JInternalFrame {

    /**
     * Creates new form busquedaproducto
     */
    DefaultTableModel model;
    String[] titulos = {"Id","Codigo","Nombre","Cantidad","Precio","Subtotal","Lote","No.Compra","Factura","Fecha","Usuario"};
    int estado = 0;
    ...
    public Detalledevoluvionesproveedor() {
        initComponents();
        formatotabla();
        addEscapeKey();
    }
        ...
        try {
            ...
            if (rs.next()) {//verifica si esta vacio, pero desplaza el puntero al siguiente elemento
                ...
                while (rs.next()) {
                    ...
                    fila[8] = rs.getString("compra.numdoc");
                    fecha=formatof.format(rs.getDate("devoluciones.fecha"));
    ...
    private void initComponents() {
        ...
        detalleabonos.setModel(model = new DefaultTableModel(null, titulos)
            ...
            jLabel21.setText("<--Detalle de Devoluciones Proveedor-->");
