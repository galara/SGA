...
//    }
    ...
    public static ResultSet EnlSalidas(ResultSet rs,String fecha1, String fecha2) throws SQLException {
        ...
        rs = st.executeQuery("SELECT\n"
                ...
                + "     INNER JOIN usuario ON salida.usuario_idusuario = usuario.idusuario where salida.fecha BETWEEN '" + fecha1 + "' and '" + fecha2 + "' order BY salida.fecha asc");
        return rs;
    }
    ...
    public static ResultSet EnlIngresos(ResultSet rs,String fecha1, String fecha2) throws SQLException {
        ...
        rs = st.executeQuery("SELECT\n"
                ...
                + "     INNER JOIN proveedor ON compra.proveedor_idproveedor = proveedor.idproveedor where compra.fecha BETWEEN '" + fecha1 + "' and '" + fecha2 + "' order BY compra.fecha asc");
        return rs;
    }
